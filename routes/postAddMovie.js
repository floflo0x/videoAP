        ...
        if (type === 'tv') {
            ...
            try {
                if (combinedData.length >= 1) {
                    combinedData.forEach(i => {
                        ...
                        let values1 = `\'${seasonId}\', '3\', '${seasonNumber}\', '${type}\', '${lang}\', '${i.id}\', '${i.filecode}\', '${i.fileSubCode}\', '${i.file_url}\'`;

                        // console.log(values1);

                        let opt1 = insertFunction(
                            "insert into videos (season_id, user_id, season_number, season_type, lang, video_id, filecode, file_sub_code, fileUrl) values("
                                .concat(`${values1}`)
                                .concat(")"),
                            "select * from videos"
                        );
            ...
            if (typeof movieId === 'object' 
                ...
                combinedData.forEach(i => {
                    ...
                    let values1 = `\'${selectedMovieId}\', '3\', 'null\', 'collectionMovie\', '${lang}\', '${i.id}\', '${i.filecode}\', '${i.fileSubCode}\', '${i.file_url}\'`;
                ...
                let values1 = `\'${movieId}\', '3\', 'null\', '${type}\', '${lang}\', '${movieId}\', '${filecode}\', '${fileSubCode}\', '${file_url}\'`;
